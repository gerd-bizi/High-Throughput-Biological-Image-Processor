%adapted from Dr. Ginzberg's example

function [pixel_list] = segmentationEngine(im)
...
pixel_list = regionprops(L, "PixelIdxList"); %get the pixels into a matrix to read from
end
